...
tokenizer = BartTokenizer.from_pretrained('pretrained_models/facebook/bart-large')
BOS_TOKEN_ID = 0
PAD_TOKEN_ID = 1
EOS_TOKEN_ID = 2
UNK_TOKEN_ID = 3
...
if __name__ == "__main__":
    ...
    model = BartForConditionalGeneration.from_pretrained('pretrained_models/facebook/bart-base')
