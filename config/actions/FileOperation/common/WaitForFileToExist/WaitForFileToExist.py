...
config_path = "config/actions/FileOperation/common/WaitForFileToExist/WaitForFileToExist.yaml"
...
def WaitForFileToExist(args):
    args = decorate_args(args)
    args_str = function_args2str(config, args)
    rets_str = function_rets2str(config, args)
    return f"{rets_str} = WaitForFileToExist({args_str})"
