...
config_path = "tbot/config/actions/OfficeAutomation/Word/WordCutSelectTextContentCommnad/WordCutSelectTextContentCommnad.yaml"
...
def WordCutSelectTextContentCommnad(args, vars):
    args = decorate_args(args, vars)
    args_str = function_args2str(config, args)
    return f"WordCutSelectTextContentCommnad({args_str})"
