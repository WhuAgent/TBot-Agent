...
class WorkSelectTextContentPosition(BaseService):
    ...
    def forward(self, args, vars):
        ...
        result = f"WorkSelectTextContentPosition({args_str})"
        message = f"成功在{args['document']}中查找文本{args['content']}，查找文本后光标位置：{args['curse_position']}"
