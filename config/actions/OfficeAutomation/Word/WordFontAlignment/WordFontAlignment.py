...
config_path = "tbot/config/actions/OfficeAutomation/Word/WordFontAlignment/WordFontAlignment.yaml"
...
def WordFontAlignment(args, vars):
    args = decorate_args(args, vars)
    args_str = function_args2str(config, args)
    return f"WordFontAlignment({args_str})"
