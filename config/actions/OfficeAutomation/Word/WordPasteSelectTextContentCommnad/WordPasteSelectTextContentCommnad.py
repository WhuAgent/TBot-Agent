...
config_path = "tbot/config/actions/OfficeAutomation/Word/WordPasteSelectTextContentCommnad/WordPasteSelectTextContentCommnad.yaml"
...
def WordPasteSelectTextContentCommnad(args, vars):
