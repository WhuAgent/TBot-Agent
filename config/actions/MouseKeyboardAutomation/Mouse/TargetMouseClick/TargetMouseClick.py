...
config_path = "config/actions/MouseKeyboardAutomation/Mouse/TargetMouseClick/TargetMouseClick.yaml"
...
def TargetMouseClick(args):
    args = decorate_args(args)
    args_str = function_args2str(config, args)
    return f"TargetMouseClick({args_str})"
